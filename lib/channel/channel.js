...
var unpackMessage = require('./mp').unpackMessage
...
Channel.prototype = {
  ...
  _destroySocket: function(){
    if(this._socket){
      ...
      this._socket.removeListener('readable', this._hdl.data)
  ...
  hdl:{
    ...
    message: function(m){
      switch(m[0]){
        ...
        case RPC.invoke: {
          ...
          __assert(typeof sid === 'number' && typeof event === 'string',
        ...
        case RPC.chunk: {
          ...
          __assert(typeof sid === 'number', Buffer.isBuffer(buf),
        ...
        case RPC.error: {
          ...
          __assert(typeof errno === 'number', typeof message === 'string',
        ...
        case RPC.terminate: {
          ...
          __assert(typeof code === 'number', typeof message === 'string',
        ...
        default: {
          throw Error('bad match: ' + JSON.stringify(m))
        }
      }
    },
    ...
    data: function(buf){
      ...
      trace && console.log('Worker got data in channel', buf)
      if(this._inBuffer){
