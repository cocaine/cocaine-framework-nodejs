...
var makeClient = require('./service').makeClient
...
function Client(locatorEndpoint){
  EventEmitter.call(this)
  this._state = 'closed'
  this._locatorEndpoint = locatorEndpoint || ['127.0.0.1', 10053]
  this.Locator = makeClient('locator', [this._locatorEndpoint, 1, ['resolve']],
