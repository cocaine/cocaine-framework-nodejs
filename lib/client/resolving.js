  ...
  handlers: {
    ...
    _doConnect: function(){
      ...
      function _locatorBeforeError(err){
        trace && console.log('function _locatorBeforeError(err){')
        trace && console.log('locator._service._state', locator._service._state)
      ...
      function _locatorError(err){
        trace && console.log('function _locatorError(err){')
        __assert(_this._resolving, '_this._resolving')
        _this._resolving = false
