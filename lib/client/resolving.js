  ...
  handlers: {
    ...
    _doConnect: function(){
      ...
      function _locatorBeforeError(err){
        console.log('function _locatorBeforeError(err){')
        console.log('locator._service._state', locator._service._state)
        __assert(_this._resolving, '_this._resolving')
        err.condition = 'locator'
        if(_this.emitError(err)){
      ...
      function _locatorError(err){
        console.log('function _locatorError(err){')
        __assert(_this._resolving, '_this._resolving')
        _this._resolving = false
