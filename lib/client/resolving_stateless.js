...
module.exports.ResolvingStateless = ResolvingStateless
...
Session.prototype = {
  ...
  pushError: function(code, message){
    ...
    if(typeof this._cb === 'function'){
      var err = new Error(util.format('<Service %s>.%s error: "%s" args: %s',
                                this._serviceName, this._methodName, message, util.inspect(this._args)))
      err.code = code
      this._cb(err)
    }
  }
...
function ResolvingStateless(options){
