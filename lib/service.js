...
function makeClient(name, result, def){
...
var baseClientConnect = BaseService.prototype.connect
...
function serviceConnect(){
  ...
  function _resolve(){
    ...
    locator.resolve(_this._name, _resolveDone)
  }
  ...
  function _connect(){
    ...
    if(!done){
      ...
      baseClientConnect.call(_this, _this._endpoint)
    } else {
